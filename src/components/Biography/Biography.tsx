      ...
      >
        {t.raw("jobs")?.map((job: Job, index: number) => (
          <>
            ...
            <article
              key={index}
              className="w-full md:w-5/6 h-full p-6 bg-zinc-700/20 rounded-xl border-l-4 border-b-4 border-zinc-500/90 shadow-xl"
            >
      ...
      >
        {t.raw("courses")?.map((course: Course, index: number) => (
          <>
            ...
            <article
              key={index}
              className="w-5/6 h-full p-6 bg-zinc-700/20 rounded-xl border-l-4 border-b-4 border-zinc-500/90 shadow-xl"
            >
